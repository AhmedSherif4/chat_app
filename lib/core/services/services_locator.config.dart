...
import 'package:chat/core/shared_widgets/image_pick/image_pick_view_model/image_pick_bloc.dart'
    as _i86;
import 'package:chat/features/login/data/login_repository/login_usecase.dart'
    as _i594;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i618.SplashBaseRepository>(() => _i618.SplashRepository(
    ...
    gh.lazySingleton<_i357.BaseAppSecurityData>(() => _i357.AppSecurityData(
        localDataSource: gh<_i476.BaseLocalDataSource>()));
    gh.lazySingleton<_i650.LoginBaseRepository>(() => _i650.LoginRepository(
    ...
    gh.lazySingleton<_i594.LoginUseCase>(
        () => _i594.LoginUseCase(repository: gh<_i650.LoginBaseRepository>()));
    gh.factory<_i166.LoginCubit>(() => _i166.LoginCubit(
